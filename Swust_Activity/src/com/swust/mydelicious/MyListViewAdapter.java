...
public class MyListViewAdapter extends BaseAdapter {
	...
	public MyListViewAdapter(Context context, List<DeliciousEntity> delicious_list2 ){
		this.delicious_list = delicious_list2;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(convertView == null){
			convertView = inflater.inflate(R.layout.my_delicious_item,null);
